...
def main():
    ...
    subparser.add_argument("--train-ptb-path", default="data/train_con.txt")
    subparser.add_argument("--dev-ptb-path", default="data/dev_con.txt")
    subparser.add_argument("--dep-train-ptb-path", default="data/train_dep.txt")
    subparser.add_argument("--dep-dev-ptb-path", default="data/dev_dep.txt")
    ...
    subparser.add_argument("--dataset", default="ptb")
    subparser.add_argument("--consttest-ptb-path", default="data/test_con.txt")
    subparser.add_argument("--deptest-ptb-path", default="data/test_dep.txt")
